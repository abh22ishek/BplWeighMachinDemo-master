...
//    public static String CLIENT_CHARACTERISTIC_CONFIG = "00001810-0000-1000-8000-00805f9b34fb";
	...
	public static byte[] data = { (byte) 0xAA, 0x06, 0x78, 0x00, 0x00, 0x00, 0x00, 0x00 };
	public static byte[] data2 = { (byte) 0xAA, 0x06, 0x78, 0x08, 0x00, 0x00, 0x00, 0x00 };//

	public static byte[] data4 = { (byte) 0xAA, 0x05, (byte) 0x7A, 0x00, 0x00, 0x00, 0x00 };// 7.2.5(ID:122)
	public static byte[] data6 = { (byte) 0xAA, 0x04, (byte) 0x7F, 0x00, 0x00, 0x00 };// 7.2
...
//	public static byte[] data8 = { (byte) 0xAA, 0x05, (byte) 0x50, 0x04, 0x00,0x00,0x00 };
	...
	public static byte[] resendBleData(int b1, int b2, int b3, int b4) {
		byte[] data = { (byte) 0xAA, 0x07, (byte) 0x7B,
				(byte)b1, (byte)b2, (byte)b3, (byte)b4, 0x00, 0x00 };
		return data;
	}
