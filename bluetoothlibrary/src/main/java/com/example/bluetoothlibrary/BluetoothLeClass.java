...
public class BluetoothLeClass{
    ...
    public interface OnStopBioLightListner{
	...
	private OnStopBioLightListner onStopBioLightListner;

    public void setOnStopBioLight(OnStopBioLightListner onStopBioLightListner) {
        this.onStopBioLightListner = onStopBioLightListner;
    }
	...
	public void setOnServiceDiscoverListener(OnServiceDiscoverListener l)
    {
        ...
        Log.d("OnServiceDiscLisner","OnServiceDiscoverListener is initialized");
    ...
    public void setLeScanCallback(){
        ...
        mLeScanCallback= new BluetoothAdapter.LeScanCallback() {
            ...
            public void onLeScan(final BluetoothDevice device, int rssi, final byte[] scanRecord) {
                Log.e("**Device Name**",device.toString());
            ...
            public void onServicesDiscovered(BluetoothGatt gatt, int status) {
                ...
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    if(mOnServiceDiscoverListener==null){
                        ...
                        Log.e("onServicesDiscovered()","<-mOnServiceDiscoverListener-> is null");
                    }
...
//                    broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            ...
            public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic,
                ...
                Log.w(TAG,"----BioLight Pause Mode ()-------");
                Log.d("test", "onCharacteristicWrite----");
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    Log.d("test", "BluetoothGatt.GATT_SUCCESS");
                    Log.w(TAG,"----BioLight Pause Mode () in GATT Success-------");
     ...
     *            Characteristic to act on.  �����Լ���˾��Ѫѹ�� �Ŀ�֪ͨ��
     * @param enabled
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic, boolean enabled, ConnectBleServiceInfo serviceInfo) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter not initialized in set characteristics Notification ()");
...
//    }
    ...
    public boolean connect(final String address) {
        ...
        isBLEConnected=true;
        connectingDevice = device.getName();//�������ӵ��豸��
        mBluetoothDeviceAddress = address;//�������ӵ��豸��ַ
        return true;
    }
    /**
     *
    ...
    public void disconnect() {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter not initialized in Disconnect() method");
            return;
        }
    ...
    public void close() {
        if (mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothGatt is  not initialized in close() method");
            return;
        }
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter not initialized read characterstics()");
            return;
        }
    ...
    public void writeCharacteristic(byte[] data) {
        ...
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.d(TAG, "BluetoothAdapter not initialized in write characteristics ()");
            return;
        }
    ...
    private byte[] crcCheck(byte[] datas) {
        ...
        byte crc = 0x00;
        Log.d("Teest crc Check-->>", "send---------->>>--start-");

        for (int i = 1; i < datas.length - 1; i++) {

            Log.d("Test byte array length", "sending....>>" + datas[i]);
            crc += datas[i];
        }
    ...
    public void writeCharacteristic_wbp(byte[] data) {
        ...
        Log.w("BIOLIGHT", "---writeCharacteristic----");

        if (mBluetoothAdapter == null || mBluetoothGatt == null || data == null) {
            Log.w(TAG, "BluetoothAdapter not initialized in write characteristics wbp()");
            return;
        }
        if (Constant.BLT_WBP.equals(connectingDevice)||Constant.BLT_WF1.equals(connectingDevice)) {
            ...
            mBluetoothGattCharacteristic = myBluetoothGattService.
                    getCharacteristic(UUID.fromString(SampleGattAttributes.GetCharacteristicIDfbb2));
            ...
            Log.w("STOP BIOLIGHT", "----stop biolight-succcessfullyt-----");
        }
    }
    /**
