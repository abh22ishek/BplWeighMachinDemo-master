...
//                    Log.d("?????????????????ID",""+heartId);
                    ...
                    {
//                        Log.d("heartState.substring(0,1)"+heartState.substring(0,1),"??"+"");
                    }else{
//                        Log.d("heartState.substring(0,1)"+heartState.substring(0,1),"???"+"");
                    }
                    if (heartState.substring(1,2).equals("1"))
                    {
//                        Log.d("heartState.substring(1,2)"+heartState.substring(1,2),"?????1????"+"");
...
//                        Log.d("heartState.substring(1,2)"+heartState.substring(1,2),"?????1??????"+"");
                    ...
                    {
//                        Log.d("heartState.substring(2,3)"+heartState.substring(2,3),"?????2????"+"");
...
//                        Log.d("heartState.substring(2,3)"+heartState.substring(2,3),"?????2??????"+"");
                    ...
                    {
//                        Log.d("heartState.substring(3,4)"+heartState.substring(3,4),"????????"+"");
...
//                        Log.d("heartState.substring(3,4)"+heartState.substring(3,4),"??????????"+"");
                    ...
                    {
//                        Log.d("heartState.substring(4,5)"+heartState.substring(4,5),"????????"+"");
...
//                        Log.d("","????");
                    ...
                    {
//                        Log.d("","????"+DeviceState.substring(1,4));
...
//                        Log.d("????","DeviceState.substring(1,4)"+DeviceState.substring(1,4));
                    }
