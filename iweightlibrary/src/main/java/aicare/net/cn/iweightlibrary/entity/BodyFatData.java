...
public class BodyFatData implements Serializable {
    ...
    public BodyFatData(String date, String time, double weight, double bmi, double bfr, double sfr, int uvi, double rom, double bmr, double bm, double vwc, int bodyAge, double pp, int number, int sex, int age, int height, int adc) {
        this.date = date;
        this.time = time;
        this.weight = weight;
        this.bmi = bmi;
    ...
    public String toString() {
        return "BodyFatData [date=" + date + ", time=" + time + ", weight=" + weight
                ...
                + number + ", 性别sex=" + sex + ", 年龄age=" + age + ", 身高height=" + height + ", 阻抗值adc=" + adc + "]";
    }
}
