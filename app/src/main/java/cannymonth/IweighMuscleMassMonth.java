...
public class IweighMuscleMassMonth extends View {
    ...
    List<RecordDetailWeighMachine> listMuscleMass;
    ...
    public IweighMuscleMassMonth(Context context) {
        super(context);
        init();
    }

    public IweighMuscleMassMonth(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public List<String> setPlotPoints(List<String> points){
        ...
        Logger.log(Level.DEBUG,"Custom View ","**Month record size**="+muscleMassList.size());
