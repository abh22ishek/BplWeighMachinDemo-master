...
public class IweighBoneMassMonth extends View {
    ...
    public IweighBoneMassMonth(Context context) {
        super(context);
        init();

    }

    public IweighBoneMassMonth(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public List<String> setPlotPoints(List<String> points){
        boneMassList=points;
        Logger.log(Level.DEBUG,"Custom View ","**Month record size**="+boneMassList.size());
