...
public class RangeBar extends View {
    ...
    private customviews.customrangebar.Thumb mLeftThumb;
    private customviews.customrangebar.Thumb mRightThumb;
    private customviews.customrangebar.Bar mBar;
    private customviews.customrangebar.ConnectingLine mConnectingLine;

    private customviews.customrangebar.RangeBar.OnRangeBarChangeListener mListener;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // The customrangebar width should be as large as possible.
        ...
        // The customrangebar height should be as small as possible.
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mLeftThumb = new customviews.customrangebar.Thumb(ctx,
                yPos,
                mThumbColorNormal,
                mThumbColorPressed,
                mThumbRadiusDP,
                mThumbImageNormal,
                mThumbImagePressed);
        mRightThumb = new customviews.customrangebar.Thumb(ctx,
                yPos,
                mThumbColorNormal,
                mThumbColorPressed,
                mThumbRadiusDP,
        ...
        mBar = new customviews.customrangebar.Bar(ctx, marginLeft, yPos, barLength, mTickCount, mTickHeightDP, mBarWeight, mBarColor);
        ...
        mConnectingLine = new customviews.customrangebar.ConnectingLine(ctx, yPos, mConnectingLineWeight, mConnectingLineColor);
    }
    ...
    /**
     * Sets a listener to receive notifications of changes to the customrangebar. This
     * will overwrite any existing set listeners.
     *
     * @param listener the customrangebar notification listener; null to remove any
     *            existing listener
     */
    public void setOnRangeBarChangeListener(customviews.customrangebar.RangeBar.OnRangeBarChangeListener listener) {
        mListener = listener;
    }

    /**
     * Sets the number of ticks in the customrangebar.
     *
     ...
     * Numbered from 0 to mTickCount - 1 from the back.
     *
     * @param leftThumbIndex Integer specifying the index of the back thumb
    ...
    /**
     * Gets the index of the back-most thumb.
     *
     * @return the 0-based index of the back thumb
     */
    ...
    /**
     * Does all the functions of the constructor for customrangebar. Called by both
     * customrangebar constructors in lieu of copying the code for each constructor.
     *
    ...
    private void createBar() {
        ...
        mBar = new customviews.customrangebar.Bar(getContext(),
                getMarginLeft(),
                getYPos(),
                getBarLength(),
                mTickCount,
    ...
    private void createConnectingLine() {
        ...
        mConnectingLine = new customviews.customrangebar.ConnectingLine(getContext(),
                getYPos(),
     ...
     *
     * @param leftThumbIndex Integer specifying the back thumb index.
    ...
    private void onActionMove(float x) {
        ...
        if (mLeftThumb.getX() > mRightThumb.getX()) {
            final customviews.customrangebar.Thumb temp = mLeftThumb;
     ...
     */
    private void pressThumb(customviews.customrangebar.Thumb thumb) {
        if (mFirstSetTickCount == true)
            mFirstSetTickCount = false;
        thumb.press();
        invalidate();
     ...
     */
    private void releaseThumb(customviews.customrangebar.Thumb thumb) {
     ...
     */
    private void moveThumb(customviews.customrangebar.Thumb thumb, float x) {
    ...
    /**
     * A callback that notifies clients when the customrangebar has changed. The
