...
public class MyCustomPRGraph extends View{
    ...
    public MyCustomPRGraph(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Logger.log(Level.DEBUG,MyCustomPRGraph.class.getSimpleName(),"**OnDraw() gets called **");
        ...
        canvas.drawText("0",0,getHeight(),mPaint);
        ...
        canvas.drawText("PR",getWidth()/2-30,getHeight()/2,paint);
