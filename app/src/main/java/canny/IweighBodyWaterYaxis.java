...
public class IweighBodyWaterYaxis extends View {
    ...
    public IweighBodyWaterYaxis(Context context) {
        super(context);
        init();
    }

    public IweighBodyWaterYaxis(Context context,  AttributeSet attrs) {
        super(context, attrs);
        init();
    }
