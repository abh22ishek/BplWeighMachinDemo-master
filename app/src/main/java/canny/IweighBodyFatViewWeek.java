...
public class IweighBodyFatViewWeek extends View {
    ...
    Path path ;
    public IweighBodyFatViewWeek(Context context) {
        super(context);
        init();
    }


    public IweighBodyFatViewWeek(Context context,AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public List<String> setPlotPoints(List<String> points){
        bodyFatList=points;
        Logger.log(Level.DEBUG,"Custom View ","**Day record size**="+bodyFatList.size());
        return bodyFatList;
    }
}
