...
public class IweighMetabolismViewWeek extends View {
    ...
    public IweighMetabolismViewWeek(Context context) {
        super(context);
        init();
    }

    public IweighMetabolismViewWeek(Context context,  AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public List<String> setPlotPoints(List<String> points){
        ...
        Logger.log(Level.DEBUG,"Custom View ","**Week record size**="+metabolismList.size());
