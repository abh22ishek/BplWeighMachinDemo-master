...
public class IweighBodyWaterView extends View {
    ...
    List<RecordDetailWeighMachine> listBodyFat;
    ...
    public IweighBodyWaterView(Context context) {
        super(context);
        init();
    }

    public IweighBodyWaterView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
...
*/
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(listBodyFat.size()<=3){
            setMeasuredDimension((6*listBodyFat.size()*pixels_per_unit)+pixels_per_unit,
                    7*pixels_per_unit);
        }else{
            setMeasuredDimension((2*listBodyFat.size()*pixels_per_unit)+pixels_per_unit,
                    7*pixels_per_unit);
        }
